...
class Post(models.Model):
    ...
    def __str__(self):
        return f"Post de {self.user} le {self.date}"
...
class Comments(models.Model):
    ...
    def __str__(self):
        return f"Commentaire de {self.user} au post de {self.post.user} le {self.date}"
...
class Reponse(models.Model):
    ...
    def __str__(self):
        return f"Reponse de {self.user} au commentaire de {self.commentaire_source.user} le {self.date} "
